    	...
    	<div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-md-1" style="line-height: 74px;">
                  <span class="upload-img"><img src="<?php echo static_url()?>/uploads/tour_services_images/<?php echo isset($edit[0]->id) ? $edit[0]->id : ''; ?>/<?php echo isset($edit[0]->image) ? $edit[0]->image : ''; ?>" alt="" id="load_image" style="width:30px;height: 30px"></span>
                </div> 
            </div>      
            <div class="row">
