    ...
    <!-- Modal content-->
    	<div class="modal-content">
      		<div class="modal-body">
        		<h3>Add offline Package request</h3>
            <hr>
            <form method="post" id="OfflinePackageRequestform">
		        <input type="hidden" name="id" id="id">
		        <div class="row">
              <div class="col-md-6 form-group">
                <label>Tours Required</label>
                <input type="text" name="tourreq" class="form-control" id="tourreq" placeholder="Enter tour required">
              </div> 
              <div class="col-md-6 form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6 form-group">
                ...
                <input type="text" class="form-control" id="checkout" name="checkout" value="<?php echo date('m/d/Y') ?>">
            ...
            <div class="row">
              <div class="col-md-12 form-group">
                <button class="pull-right btn btn-success ml10" id="OfflinePackageRequestSubmit">Submit</button>
                <button type="button" data-dismiss="modal" id="OfflinePackageRequestreject_button" class="close_but btn btn-danger ml10 pull-right">No</button>
              </div>
            </div>
      		</div>
        </form>
