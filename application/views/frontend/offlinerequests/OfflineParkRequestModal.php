...
<div class="modal-dialog" style="height: 100%;overflow-y:auto;">
    <!-- Modal content-->
    	<div class="modal-content">
      		<div class="modal-body">
        		<h3>Add offline park request</h3>
            <hr>
            <form method="post" id="OfflineParkRequestform">
		        <input type="hidden" name="id" id="id">
		        <div class="row">
              <div class="col-md-6 form-group">
                <label>Themepark</label>
                <input type="text" name="themePark" class="form-control" id="themePark" placeholder="Enter themepark..">
              </div> 
              <div class="col-md-6 form-group">
            ...
            <div class="row"> 
              <div class="col-md-6 form-group">
                <label>Date</label>
                <input type="text" class="form-control" id="pdate" name="pdate" value="<?php echo date('m/d/Y') ?>">
            ...
            <div class="row">
              <div class="col-md-12 form-group">
                <button class="pull-right btn btn-success ml10" id="OfflineParkRequestSubmit">Submit</button>
                <button type="button" data-dismiss="modal" id="OfflineParkRequestreject_button" class="close_but btn btn-danger ml10 pull-right">No</button>
              </div>
            </div>
      		</div>
        </form>
    ...
    <script type="text/javascript">
      // @datepicker
      // datepicker  for date
      var nextDay = new Date($("#pdate").val());
      ...
      $("#pdate").datepicker({
          ...
          nextDay.setDate(nextDay.getDate() + 1);
          $("#pdate").datepicker('option', 'minDate', nextDay);
            setTimeout(function(){
