...
<div class="row">
	...
	<div class="col-md-6">
		...
		<a class="pull-right btn btn-primary" href="<?php echo  base_url(); ?>offlinerequests/agenttour_requests">back</a>
	</div>
</div>
</div>
...
<div class="row">
	<div class="col-md-12">
		<div class="row">
			<div class="col-md-12">
				<h4 class="dark bold">Tour Booking Details</h4>
			</div>
			<div class="col-md-12">
					<div class="col-md-6">
						<p><span class="opensans size17 bold"><?php echo $view[0]->tour_type ?></span></p>
					</div>
				</div>
		</div>
	</div>
	<div class="col-md-12 sleft_bor">
		<div class="row">
			...
			<div class="col-md-12">
				<div class="col-md-6">
					<span>Booking Id : TOB<?php echo $view[0]->id ?></span><br>
               			...
               			<table class="table-bordered" >
            				...
            				<tbody>	
            					<tr>
            							...
            							<td style="text-align: left"><?php echo $view[0]->tour_type; ?></td>
