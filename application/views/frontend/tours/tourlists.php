...
<style>
		.listitem {
		    background-image: url(../skin/images/travel-png.png) ! important;
			...
			<div class="col-md-3 filters offset-0">
				...
				<div class="filtertip">
					<div class="padding20">
						<p class="size13">
							Total 
							<span class="size18 bold counttour"></span> <span class="transfercnt">Tours</span> </p>
				...
				<div class="size30 dark">Tours</div>				
					...
					<input type="hidden" name="cityId"  value="<?php echo $_REQUEST['cityId'] ?>">
						...
						<div class="margtop10">
							<span class="opensans size1 arrival_err">Date of Tour</span>
