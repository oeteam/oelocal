	...
	<div class="container">
		<div class="margtop40">
			<div class="col-md-offset-3 col-md-6 box-blue">
				<div class="row">
					<h1 class="text-white text-center">Registered</h1>
				</div>
				<div class="row">
					<h2 class="text-center text-white"><i class="fa fa-check-circle fa-fw fa-4x text-green"></i></h2>
					<h4 class="text-center text-white margtop40"><b class="text-green">Congratulation!</b> Agent Registration is successful</h4>
					<p class="text-center text-white">We have send you e-mail for verification</p>
				</div>
				<div class="row margtop40 text-white">
					<p class="text-center text-light" style="margin: 0">Please verify your email address to complete your account registration</p>
				</div>
			</div>
		</div>
		<div class="col-md-offset-3 col-md-6 margtop40">
			<div class="row">
				<p class="text-center"><a href="<?php echo get_cdn_url(); ?>" class="lblue">Back to Login</a></p>
			</div>
		</div>
	</div>
</body>
