							...
							<div id="hotel" class="tab-pane fade active in">
								<div class="row">
									<div class="col-xs-12 col-md-6">
										<label for="location" class="dest_err control-label text-white">From the airport</label>
									...
									<div class="col-md-6">
										<div class=" textleft">
											...
											<input type="text" style="margin-left: 25px;" placeholder="Return Date/Time" class="form-control datetime returndate datePic-style hide" id="returndate" name="returndate" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row" style="margin-top: 15px;">
									<div class="col-md-4">
										...
										<div class="col-md-4">
											<div class="radio radiomargin0">
											  <label class="bold control-label text-white">
												<input type="radio" name="transfertype" class="type" value="two-departure">
												Departure
											  </label>
											</div>
										</div>
