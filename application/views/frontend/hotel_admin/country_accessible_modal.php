        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-xs-5">
                    ...
                    <select name="country_from[]" id="undo_redo" class="form-control" size="13" multiple="multiple">
                        <?php foreach ($list as $key => $value) { ?>
                            <option value="<?php echo $value->A2Code ?>"><?php echo $value->countryName ?></option>
                        <?php } ?>
                    </select>
                </div>
                ...
                <div class="col-xs-5">
                    ...
                    <select name="country_to[]" id="undo_redo_to" class="form-control" size="13" multiple="multiple"></select>
                    </form>
                </div>
            </div>
