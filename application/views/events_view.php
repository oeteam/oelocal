...
<style>
  ...
  .banner-bottom {
      background-image: url("<?php echo static_url() ?>agentLoginStyle/img/eventheader.jpg");
      height: 60%;
      position: relative;
      margin-bottom: 10px;
  }
  ...
  .desc {
   ...
   .content-title {
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <!-- <section class="banner-bottom"> -->
          <img src="<?php echo images_url()?>uploads/events/<?php echo $view[0]->id ?>/<?php echo $view[0]->event_image ?>" style="width: 100%" class="img-responsive">
      <!--   </section> -->
        </div>
        <div class="col-md-6">
