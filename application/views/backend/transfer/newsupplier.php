    ...
    <div class="sb2-2">
        <div class="sb2-2-add-blog sb2-2-1">
            <div class="col s12">
                ...
                <?php } ?>
                <span class="pull-right"><a href="<?php echo base_url(); ?>backend/transfer/supplier_index" class="btn-sm btn-primary">Back</a></span>
            </div>
            <form action="<?php echo base_url(); ?>backend/transfer/addsupplier" name="add_supplier_form" id="add_supplier_form" method="post" enctype="multipart/form-data">
            </br>
            </br>
            </br>
            	...
            	<div class="col-md-12">
                    ...
                    <div class="row">
                         <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" id="phone_landline" name="phone_landline" placeholder="Landline Number" value="<?php echo isset($edit[0]->phone_landline) ? $edit[0]->phone_landline : ''; ?>">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                           <label for="list-title">Sales Contact Number</label>
                            <input type="number" class="form-control" id="salescontact_num" name="salescontact_num" placeholder="Sales Contact Number" value="<?php echo isset($edit[0]->salescontact_num) ? $edit[0]->salescontact_num : ''; ?>">
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                           <label for="list-title">Ops Contact Number</label>
                            <input type="number" class="form-control" id="ops_contact_num" name="ops_contact_num" placeholder="Ops Contact Number" value="<?php echo isset($edit[0]->ops_contact_num) ? $edit[0]->ops_contact_num : ''; ?>">
                        </div>
...
<script src="<?php echo static_url(); ?>assets/js/tour.js"></script>
<?php init_tail(); ?>
