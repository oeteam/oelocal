    ...
    <div class="sb2-2">
        <div class="sb2-2-add-blog sb2-2-1">
            <div class="col s12">
                ...
                <?php } ?>
                <span class="pull-right"><a href="<?php echo base_url(); ?>backend/transfer/contractconditions?id=<?php echo $contract_id ?>" class="btn-sm btn-primary">Back</a></span>
            </div>
            <form action="<?php echo base_url(); ?>backend/transfer/addcondition" name="add_condition_form" id="add_condition_form" method="post" enctype="multipart/form-data">
            </br>
            </br>
            </br>
...
<script>
    ...
    $('#add_condition_submit_button').click(function (e) {
      e.preventDefault();
          ...
          dataType: 'json',
          type: 'post',
          url: base_url+'/backend/transfer/condition_validation',
