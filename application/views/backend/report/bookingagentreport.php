                ...
                <div class="box-inn-sp">
                    ...
                    <form method="Post" id="AvaReport_filter" name="AvaReport_filter">
                          <div class="col-md-12"> 
                                  ...
                                  <div class="form-group col-md-2">
                                          <input type="button" class="mar_top_23 btn-sm btn-primary" id="bookingAgentReport" value="Search">
                                  </div>
                          </div>
                      </form>
                    <div class="clearfix">
...
<script>
      ...
      $("#bookingAgentReport").click(function() {
        ...
        var bookingagentTable = $('#bookingagentTable').dataTable({
          ...
          "ajax": {
            url : base_url+'backend/report/bookingAgentReportList?from_date='+from_date+'&to_date='+to_date,
            type : 'POST' 
            },
