          ...
          <input type="hidden" name="hotel_id" id="hotel_id" value="<?php echo $_REQUEST['id'] ?>">
            <div class="tab-inn">
                <div class="table-responsive">
                    <table  id="hotel_room_table_excel1">
					  ...
					  <?php 
					   ...
					   foreach ($room_list as $key => $value) { ?>
					    ...
					    <td  class="text-center coloring"><input type="hidden" name="id[]"  value="<?php echo isset($room_amount[$key][0]->id) ? $room_amount[$key][0]->id : '' ?>">
					    ...
					    <td class="coloring"><input type="text" name="peak_2[]" class="form-control" id="peak_2[]" value="<?php echo isset($room_amount[$key][0]->peak_2) ? $room_amount[$key][0]->peak_2: '' ?>"></td></td>
					    <td class="coloring"><input type="text" name="shoulder_2[]" class="form-control" id="shoulder_2[]" value="<?php echo isset($room_amount[$key][0]->shoulder_2) ? $room_amount[$key][0]->shoulder_2 : '' ?>"></td></td>
					    <td class="coloring"><input type="text" name="high_2[]" class="form-control" id="high_2[]"  value="<?php echo isset($room_amount[$key][0]->high_2) ? $room_amount[$key][0]->high_2: '' ?>"></td></td>
					    <td class="coloring"><input type="text" name="low[]" id-="low[]" class="form-control" value="<?php echo isset($room_amount[$key][0]->low) ? $room_amount[$key][0]->low : '' ?>"></td></td>
					...
					<br>
                         <button type="button" class="btn-sm btn-success update_button pull-right" id="room_rate_date_update">update</button>
                </div>
            </div>
        </form>
        </div>
