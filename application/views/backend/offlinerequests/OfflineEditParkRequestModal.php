                ...
                <div class="box-inn-sp">
                    <div class="inn-title">
                       <!-- print_r($this->session->userdata()); exit()  -->
                        <span>Offline Park Request Edit</span>
                    </div>
                </div>
            </div>
            <div class="tab-inn">
                ...
                <div class="col-md-12">
                  <div class="row">
                      <div class="col-md-12">
                        ...
                        <br>
                        <p>Request Id : PRB<?php echo $view[0]->id ?></p>
                      ...
                      <div class="col-md-12">
                            ...
                            ?>
                                <div class="col-md-12">
                                  <table class="table-bordered" >
                                    <thead style="background-color: #F2F2F2;">
                                     <tr>
                                        <th style="width: 85px;">Themepark</th>
                        ...
                        <div class="form-group">
                          ...
                          <a href="#" class="btn-sm btn-success pull-right" onclick="OfflineParkRequestUpdate();" >Update</a>
...
<script type="text/javascript">
  ...
  function OfflineParkRequestUpdate() {
  
    addToast("Updated Successfully","green");
    $("#OfflineParkRequestForm").attr('action',base_url+'backend/offlinerequest/OfflineParkRequestupdate');
    $("#OfflineParkRequestForm").submit();
