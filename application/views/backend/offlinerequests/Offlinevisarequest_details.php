...
<div class="sb2-2">
    <div class="sb2-2-3">
	  	...
	  	<div class="col-md-12 sleft_bor">
			...
			<div class="row">
				...
				<div class="col-md-6">
                        ...
                        if($visaMenu[0]->edit!=0) { ?>
							<a class="btn-sm btn-primary" href="<?php echo base_url() ?>backend/offlinerequest/OfflineEditVisaRequestModal?id=<?php echo $view[0]->id ?>">Edit</a>
							...
							<?php } else { ?>
								<a href="#" class="btn-sm btn-success" onclick="OffllineVisaRequestactionfun(<?php echo $view[0]->id ?>,1)" data-toggle="modal" data-target="#booking_modal"  class="sb2-2-1-edit delete">Accept</a> &nbsp<a class="btn-sm btn-danger " onclick="OffllineVisaRequestactionfun(<?php echo $view[0]->id ?>,0)" data-toggle="modal" data-target="#booking_modal"  href="#" > Cancel </a> 
							<?php } } ?>
							<?php if( $view[0]->requestFlg ==1 ) { 
								if ($view[0]->ContactName=="" || $view[0]->contactemail=="" || $view[0]->contactnum=="") {?> 
									<a class="btn-sm btn-danger " onclick="GuestDataValidation()" href="#" > Cancel </a> 
								<?php } else { ?> 
							<a class="btn-sm btn-danger "  onclick="OffllineVisaRequestactionfun(<?php echo $view[0]->id ?>,0)" data-toggle="modal" data-target="#booking_modal"    href="#" > Cancel </a> <?php } } 
						} ?>
						 &nbsp<a class="btn-sm btn-primary" href="<?php echo  base_url(); ?>backend/offlinerequest/visa_requests">back</a>
					</span>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6"> 
					<span>Request Id : VRB<?php echo $view[0]->id ?></span><br>
