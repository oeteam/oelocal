<div class="modal-content modal-content  col-md-6 col-md-offset-3">
  <form id="offlineParkRequestActionForm" method="post">
  ...
  $("#AcceptClick").click(function() {
      ...
      if(sellingprice=="" || sellingprice==0) {
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: base_url+'backend/offlinerequest/OfflineParkActionSubmit',
            data : $("#offlineParkRequestActionForm").serialize(),
            cache: false,
