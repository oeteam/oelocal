...
<style>
        ...
        <div class="sb2-2-add-blog sb2-2-1">
            <div class="col s12">
                ...
                <h2>New Tour Requests</h2>
                               <span class="pull-right"><a href="<?php echo base_url(); ?>backend/offlinerequest/tour_requests" class="btn-sm btn-primary">Back</a></span>
            </div>
            <form action="<?php echo base_url(); ?>backend/offlinerequest/OfflineTourRequestSubmit" name="add_tour_requests_form" id="add_tour_requests_form" method="post" enctype="multipart/form-data">
            </br>
            </br>
            </br>
            ...
            <div class="row">
            	<div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="list-title">Type of Tour</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="datePicker-hide datepicker input-group-addon" id="tdate" name="tdate" placeholder="dd/mm/yyyy" value="<?php echo date('Y-m-d') ?>" />
                        ...
                        <div class="col-md-6 col-md-offset-6">
                            <div class="form-group col-md-12">
                                <?php  if (isset($edit[0]->id) && $edit[0]->id!="") { ?>
                                     <button type="button" id="add_tour_requests_submit_button" class="waves-effect waves-light btn-sm btn-success">Update</button>
                                <?php } else { ?>
                                <button type="button" style="margin-top: 25px" id="add_tour_requests_submit_button" class="waves-effect waves-light btn-sm btn-success pull-right">Submit</button>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
 ...
 <script type="text/javascript">
    ...
    $('ul.txtcountry').on('click', 'li a', function () {
      ...
      $('#add_tour_requests_submit_button').click(function (e) {
        e.preventDefault();
          $.ajax({
          dataType: 'json',
          type: 'post',
          url: base_url+'backend/offlinerequest/tour_requests_validation',
          data: $('#add_tour_requests_form').serialize(),
          cache: false,
