            ...
            <div class="col-md-12">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        ...
                        if($tranferMenu[0]->create!=0) { ?>
                            <span class="pull-right"><a href="<?php echo base_url(); ?>backend/offlinerequest/new_transfer_requests" class="btn-sm btn-primary">Add</a></span>
                        <?php } ?>
                    </div>
                     <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive table-desi">
                            <table class="table table-condensed table-hover" id="transferRequestTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Booking ID</th>
...
<script type="text/javascript">
    var transferRequestTable = $('#transferRequestTable').dataTable({
        "bDestroy": true,
        "ajax": {
            url : base_url+'/backend/offlinerequest/offline_transfer_request_list',
            type : 'GET'
        },
...
function offlinefilter(val) {
    var transferRequestTable = $('#transferRequestTable').dataTable({
        "bDestroy": true,
        "ajax": {
            url : base_url+'/backend/offlinerequest/offline_transfer_request_list?filter='+val,
            type : 'GET'
        },
    "fnDrawCallback": function(settings){
    $('[data-toggle="tooltip"]').tooltip();          
