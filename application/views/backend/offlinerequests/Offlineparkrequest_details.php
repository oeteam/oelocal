	  	...
	  	<div class="col-md-12 sleft_bor">
			...
			<div class="row">
				...
				<div class="col-md-6">
						...
						<?php $parkMenu = menuPermissionAvailability($this->session->userdata('id'),'Offline Requests','Park');
                        if($parkMenu[0]->edit!=0) { ?>
							<a class="btn-sm btn-primary" href="<?php echo base_url() ?>backend/offlinerequest/OfflineEditParkRequestModal?id=<?php echo $view[0]->id ?>">Edit</a>
			...
			<div class="row">
				<div class="col-md-6"> 
					<span>Request Id : PRB<?php echo $view[0]->id ?></span><br>
			            			...
			            			<table class="table-bordered" >
			            				...
			            				<tbody>
			            						...
			            						<tr>
			            							...
			            							<td><?php echo $view[0]->themePark; ?></td>
...
<script>
// @offline park request action
// load the modal for offline park request status update
function OffllineParkRequestactionfun(id,val) {
  $("#booking_modal").load(base_url+"backend/offlinerequest/OfflineParkActionModal?id="+id+'&val='+val);
  $('#booking_modal').modal({
    backdrop: 'static',
    keyboard: false
  });
