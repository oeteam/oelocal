<div class="modal-content modal-content  col-md-6 col-md-offset-3">
  <form id="telr_test_action" method="get" action="<?php echo base_url(); ?>backend/common/TestPaymentGateway_Telr">
  ...
  <div class="modal-footer">
      ...
      <input type="submit" class="btn-sm btn-success" id="test_telr_button_submit" value="Pay">
