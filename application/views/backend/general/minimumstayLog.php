            ...
            <div class="col-md-12">
                <div class="box-inn-sp">
                    ...
                    <form method="get" id="bookingReport_filter">
                                  ...
                                  <div class="form-group col-md-2 ">
                                          <input type="button" class="mar_top_23 btn-sm btn-primary" id="MinimumStayButton" value="Search">
                                  </div>
                                </div>
                      </form>
                    <div class="clearfix">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive table-desi">
                            <table class="table table-condensed table-hover" id="MinimumStayTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>id</th>
...
<script>
  ...
  $("#contracts").select2({
	...
	MinimumStayTableLoad();
	$("#MinimumStayButton").click(function() {
		MinimumStayTableLoad();
	})
    ...
    function MinimumStayTableLoad() {
      ...
      var contract = $('#contracts option:selected').val();
	    var MinimumStayTable = $('#MinimumStayTable').dataTable({
	        ...
	        "ajax": {
	          url : base_url+'backend/common/MinimumStayLogList?from_date='+from_date+'&to_date='+to_date+'&hotel='+hotel+'&user='+user+'&contract='+contract,
	          type : 'POST' 
	          },
