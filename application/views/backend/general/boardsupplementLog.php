...
.multi-select-trans1 .form-control {
  ...
  #BoardSupplementTable_wrapper .btn  {
      height: 27px;
      font-size: 12px;
      line-height: 28px;
      background: #009688;
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        <span> Board Supplement Log </span>
                    </div>
                    <form method="get" id="bookingReport_filter">
                                  ...
                                  <div class="form-group col-md-2 ">
                                          <input type="button" class="mar_top_23 btn-sm btn-primary" id="BoardSupplementButton" value="Search">
                                  </div>
                                </div>
                      </form>
                    <div class="clearfix">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive table-desi">
                            <table class="table table-condensed table-hover" id="BoardSupplementTable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>id</th>
...
<script>
  ...
  $("#contracts").select2({
	...
	BoardSupplementTableLoad();
	$("#BoardSupplementButton").click(function() {
		BoardSupplementTableLoad();
	})
    ...
    function BoardSupplementTableLoad() {
      ...
      var contract = $('#contracts option:selected').val();
	    var BoardSupplementTable = $('#BoardSupplementTable').dataTable({
	        ...
	        "ajax": {
	          url : base_url+'backend/common/BoardSupplementLogList?from_date='+from_date+'&to_date='+to_date+'&hotel='+hotel+'&user='+user+'&contract='+contract,
	          type : 'POST' 
	          },
