...
<div class="modal-content modal-content  col-md-6 col-md-offset-3">
  <form id="offlineTransferRequestActionForm" method="post">
...
<script type="text/javascript">
  $("#AcceptClick").click(function() {
      ...
      if(transfer_type=="one-way" &&  (arrivalNo=="" || arrivalTime=="" || sellingprice=="" || sellingprice=='0')) {
          addToast("Please edit the requests and add both flight and price details","orange");
          $("#arrivalNo").focus();
        }
      else if(transfer_type=="two-way" && (departureTime=="" || departureNo=="" || sellingprice=="" || sellingprice=='0')){
          alert("hghgf");
          addToast("Please edit the requests and add both flight and price details","orange");
          $("#arrivalNo").focus();
        }
        ...
        $.ajax({
            dataType: 'json',
            type: "POST",
            url: base_url+'backend/offlinerequest/OfflineTransferActionSubmit',
            data : $("#offlineTransferRequestActionForm").serialize(),
            cache: false,
