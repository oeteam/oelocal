            ...
            <tbody>
              <?php for ($j=0; $j < $tot_days ; $j++) {  ?>
                <tr>
                  ...
                  <td style="text-align: right"><input type="text" class="newCost text-right" name="Room<?php echo $i; ?>[]" value="<?php echo isset($amendindividual_amount[$j]) && $amendindividual_amount!=''?$amendindividual_amount[$j]:0 ?>" <?php echo isset($amendindividual_amount[$j])&& $amendindividual_amount!=''?" readonly":"" ?>></td>
