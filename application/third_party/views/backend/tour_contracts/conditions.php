        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        <span> Tour Contracts - Terms and Conditions</span>
                        <span style="margin-left: 10px;" class="pull-right"><a href="<?php echo base_url(); ?>backend/tour/newcondition/<?php echo $contract_id ?>" class="btn-sm btn-primary">Add</a></span>
...
var conditionTable = $('#conditionTable').dataTable({
        "bDestroy": true,
        "ajax": {
            url : base_url+'/backend/tour/condition_details_list/'+contract_id,
            type : 'GET'
        },
