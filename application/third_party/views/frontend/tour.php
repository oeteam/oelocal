...
<script type="text/javascript" src="<?php echo static_url(); ?>skin/js/tour.js"></script>
							...
							<div id="hotel" class="tab-pane fade active in">
								...
								<div class="row" style="margin-top: 15px;">
									...
									<div class="col-xs-6 col-md-3">
										<div class=" textleft">
											<label for="" class="arrival_err control-label text-white">Arrival Date</label>
									...
									<div class="col-xs-6 col-md-3">
										<div class=" textleft">
											<label for="" class="depart_err control-label text-white">Departure Date</label>
											<input type="text" style="width: 0px ! important;opacity: 0" class=" mySelectCalendar" id="datepicker2" name="departdate" placeholder="mm/dd/yyyy" value="<?php echo $date; ?>" />
										</div>
