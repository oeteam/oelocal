...
<!-- Bootstrap -->
        ...
        <script src="<?php echo static_url(); ?>assets/js/details.js"></script>  
        <!-- end -->
	...
	<div class="container pagecontainer offset-0">	
			...
			<div class="col-md-4 detailsright offset-0">
				<div class="padding20">
					...
					<img src="<?php echo static_url(); ?>skin/images/smallrating-<?php echo $view[0]->rating ?>.png" alt=""/>
				</div>
					...
					<div id="roomrates" class="tab-pane fade active in">
						...
						<div class="dateCheckLoad">
							...
							<div class="spin-wrapper" style="/* display: none; */text-align: center;">
								<img src="<?php echo static_url(); ?>/assets/images/ellipsis-spinner.gif" alt="" style="width: 100px;">
							</div>
							<div class="line2"></div>
						</div>
								...
								<div class="RateCheckdiv<?php echo $value->id  ?>">
									<div class="padding20">
										<div class="col-md-4 offset-0">
											<?php if ($value->images!="") { ?>
												<a href="#"><img src="<?php echo images_url(); ?>uploads/rooms/<?php echo $value->id ?>/<?php echo $value->images; ?>" alt="" class="fwimg"/></a>
											<?php  } else { ?>
												<a href="#"><img src="<?php echo static_url(); ?>skin/images/items2/item1.jpg" alt="" class="fwimg"/></a>
											<?php } ?>
										</div>
