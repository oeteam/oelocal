...
<html>
  <head>
    ...
    <script src="<?php echo get_cdn_url('assets/js/bootstrap-multiselect.js'); ?>"></script>
    <link rel="stylesheet" href="<?php echo get_cdn_url('assets/css/bootstrap-multiselect.css'); ?>"></link>
    <style>
    .timeline {
      list-style: none;
      padding-left: 0;
    ...
    <div class="container2">        
        <div class="navbar-collapse collapse" style="background-color: #0074b9">
        	...
        	<div class="col-md-offset-2 col-md-8">
                      <a href="#"><img src="<?php echo static_url(); ?>skin/images/dash/logo.png" width="109px;height: 40px;" alt="" style="background: aliceblue"/></a>                      
                                    ...
                                    <?php foreach ($notify as $key => $value) {
                                      if ($value->booking_flag==1) { ?>
                                        <?php if ($value->readed==2){ ?>
                                            ...
                                            <a href='<?php echo base_url(); ?>Payment/agent_booking_view?id=<?php echo $value->bk_id?>'><span class="timeline-icon"><img src='<?php echo static_url(); ?>uploads/rooms/<?php echo $value->room_id ?>/<?php echo $value->images ?>' alt='' width='30' class='left margright10 roundav'/></span>
                                      ...
                                      if ($value->booking_flag==0) { ?>
                                        <?php if ($value->readed==2){ ?>
                                              <li class='msgbox  offset-0'>
                                            <?php }else{ ?><li class='msgbox read offset-0'><?php } ?><a href='<?php echo base_url(); ?>Payment/agent_booking_view?id=<?php echo $value->bk_id?>'><span class="timeline-icon"><img src='<?php echo static_url(); ?>uploads/rooms/<?php echo $value->room_id ?>/<?php echo $value->images ?>' alt='' width='30' class='left margright10 roundav'/></span>
