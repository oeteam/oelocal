...
<<<<<<< Updated upstream
              'Room1FName' => $data['first_name'][0],
              'Room2FName' => $data['first_name'][1],
              'Room3FName' => $data['first_name'][2],
              'Room4FName' => $data['first_name'][3],
              'Room5FName' => $data['first_name'][4],
              'Room6FName' => $data['first_name'][5],
              'Room1LName' => $data['last_name'][0],
              'Room2LName' => $data['last_name'][1],
              'Room3LName' => $data['last_name'][2],
              'Room4LName' => $data['last_name'][3],
              'Room5LName' => $data['last_name'][4],
              'Room6LName' => $data['last_name'][5],
=======
              'Room1-FName' => isset($data['Room1AdultFirstName'][0]) ? implode(",", $data['Room1AdultFirstName']) : '',
              'Room2-FName' => isset($data['Room2AdultFirstName'][0]) ? implode(",", $data['Room2AdultFirstName']) : '',
              'Room3-FName' => isset($data['Room3AdultFirstName'][0]) ? implode(",", $data['Room3AdultFirstName']) : '',
              'Room4-FName' => isset($data['Room4AdultFirstName'][0]) ? implode(",", $data['Room4AdultFirstName']) : '',
              'Room5-FName' => isset($data['Room5AdultFirstName'][0]) ? implode(",", $data['Room5AdultFirstName']) : '',
              'Room6-FName' => isset($data['Room6AdultFirstName'][0]) ? implode(",", $data['Room6AdultFirstName']) : '',
              'Room1-LName' => isset($data['Room1AdultLastName'][0]) ? implode(",", $data['Room1AdultLastName']) : '',
              'Room2-LName' => isset($data['Room2AdultLastName'][0]) ? implode(",", $data['Room2AdultLastName']) : '',
              'Room3-LName' => isset($data['Room3AdultLastName'][0]) ? implode(",", $data['Room3AdultLastName']) : '',
              'Room4-LName' => isset($data['Room4AdultLastName'][0]) ? implode(",", $data['Room4AdultLastName']) : '',
              'Room5-LName' => isset($data['Room5AdultLastName'][0]) ? implode(",", $data['Room5AdultLastName']) : '',
              'Room6-LName' => isset($data['Room6AdultLastName'][0]) ? implode(",", $data['Room6AdultLastName']) : '',
>>>>>>> Stashed changes
              'discount' => "",
